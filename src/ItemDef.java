...
public final class ItemDef {
	...
	public static ItemDef forID(int i) {
		...
		case 8839: {
				...
				itemDef.description = "Torso armour from the order of the Void Knights.".getBytes();
				...
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				itemDef.anInt188 = 14562;
				itemDef.anInt164 = 14570;
		}
			if(i == 8840) {
				itemDef.name = "Void knight robe";
				itemDef.description = "Leg armour of the order of the Void Knights.".getBytes();
				itemDef.modelID = 15281;
			...
			if(i == 8841) {
				...
				itemDef.description = "A mace used by the order of the Void Knights.".getBytes();
			...
			if(i == 11663) {
				...
				itemDef.description = "A mage helm from the order of the Void Knights.".getBytes();
				itemDef.modelID = 27164;
				itemDef.modelZoom = 919;
			...
			if(i == 11664) {
				...
				itemDef.description = "A ranger helm from the order of the Void Knights.".getBytes();
				itemDef.modelID = 27163;
			...
			if(i == 11665) {
				...
				itemDef.description = "A melee helm from the order of the Void Knights.".getBytes();
				itemDef.modelID = 27166;
				itemDef.modelZoom = 620;
				itemDef.modelRotation1 = 88;
				itemDef.modelRotation2 = 188;
				itemDef.modelOffset1 = 1;
				...
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear";
				itemDef.anInt188 = 27154;
				itemDef.anInt164 = 27139;
		}
			}
		return itemDef;
	}
